    ...
    >
      ...
      <div className="space-y-3">
        {skills.map((skill, idx) => (
          <div key={idx} className="flex items-center gap-3 group/item translate-x-0 hover:translate-x-1 transition-transform duration-300">
