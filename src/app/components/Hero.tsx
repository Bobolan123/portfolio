      ...
      <div className="max-w-4xl w-full relative z-10">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-extrabold mb-6 pb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400"
          >
            Nguyen Hoang Lan
          </motion.h1>
